          ...
          <View style={styles.inner}>
            <View style={styles.header}>
              ...
              <View style={styles.headerButtons}>
                <TouchableOpacity onPress={() => showTechnicalInfo('formula')} style={styles.iconButton}>
            ...
            <View style={styles.actionsContainer}>
              <TouchableOpacity style={styles.actionButton} onPress={() => showTechnicalInfo('motor')}>
                <FontAwesome name="cog" size={18} color="#4A90E2" />
                <Text style={styles.actionText}>Động cơ</Text>
              </TouchableOpacity>
              
              <TouchableOpacity style={styles.actionButton} onPress={() => showTechnicalInfo('transmission')}>
                <FontAwesome name="gears" size={18} color="#4A90E2" />
                <Text style={styles.actionText}>Bộ truyền</Text>
              </TouchableOpacity>
              
              <TouchableOpacity style={styles.actionButton} onPress={() => showTechnicalInfo('formula')}>
